...
//  the actuators are mechanical: a servo swinging 48 degrees at 900 deg/s is
//  already 53 ms behind, and a solenoid does not have its plunger home until
//  its pull-in burst is over.  Starting the attack immediately means the first
